  ...
  const components = [
    {
      ...
      size: [0.8, 0.6, 0.1] as [number, number, number],
    },
    {
      id: "usb-port",
      label: "USB-PORT",
      position: [-1.5, 0, 0.1] as [number, number, number],
      size: [0.3, 0.2, 0.15] as [number, number, number],
    },
    {
      id: "voltage-reg",
      label: "AMS1117-3.3",
      position: [1.2, -0.8, 0.08] as [number, number, number],
      size: [0.25, 0.2, 0.08] as [number, number, number],
    },
    {
      id: "cp2102",
      label: "CP2102",
      position: [-1.2, -0.8, 0.08] as [number, number, number],
      size: [0.3, 0.25, 0.08] as [number, number, number],
    },
    {
      id: "gpio-pins",
      label: "GPIO PINS",
      position: [0, 1.5, 0.05] as [number, number, number],
      size: [2.5, 0.15, 0.08] as [number, number, number],
    },
    {
      id: "crystal",
      label: "40MHz XTAL",
      position: [0.8, 0.6, 0.08] as [number, number, number],
      size: [0.2, 0.2, 0.08] as [number, number, number],
    },
  ];
