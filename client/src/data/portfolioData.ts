...
export const projects: Project[] = [
  {
    ...
    shortDescription:
      "First comprehensive red-teaming framework for South African languages created by my team and I",
    techStack: [
      "Python",
      "AI Safety",
      "Red Teaming",
...
Created an interactive Streamlit dashboard for exploring results by model, language, and harm category.`,
  ...
  },
  {
    ...
    description:
      "Predicting Post-Harvest Freshness Using Simulated Hyperspectral Signatures",
    shortDescription:
      "**Coming Soon:** Hardware product using sensors to capture real hyperspectral data",
    techStack: [
      "Python",
      "NumPy",
      "Pandas",
...
The goal is to translate the simulation findings (Red-edge at 760nm, NIR at 1100nm as key freshness indicators) into a portable, real-world device accessible without lab equipment.`,
  ...
  },
  {
    ...
    shortDescription:
      "Neural wake-word detection, biometric voiceprints, and gesture recognition",
    techStack: [
      "Python",
      "PyAutoGUI",
      "Selenium",
...
export const experiences: Experience[] = [
  {
    ...
    description:
      "Focusing on Battery Management Systems and swappable battery technology for electric vehicles.",
    bulletPoints: [
  ...
  },
  {
    ...
    location: "Cape Town, Western Cape, South Africa",
    description:
      "Contributing to the power subsystem of UCT Racing's Formula Student electric vehicle.",
    bulletPoints: [
  ...
  },
  {
    ...
    location: "Cape Town, Western Cape, South Africa",
    description:
      "Completed a 2-week STEM Research Methodology Workshop with independent research framework.",
    bulletPoints: [
...
export const research: Research[] = [
  {
    ...
    date: "May 2026",
    summary:
      "Developed a computational framework to predict post-harvest freshness using simulated hyperspectral signatures as a low-cost alternative to lab-based analysis. Mentored by Dr. Juan F. Arratia (Scientific Caribbean Foundation) and Prof. Komla Folly (UCT).",
    methodology:
      "Python-based simulation using NumPy, Pandas, Scikit-learn and Matplotlib. Feature importance ranking across spectral regions. Five-stage process: Literature Review → Variable Selection → Simulation Model → Feature Ranking → Theoretical Validation.",
    outcome:
      "Demonstrated that Red-edge (760nm) and NIR (1100nm) spectral bands are highly predictive of freshness before visible spoilage. Freshness declines nonlinearly with faster drop after mid-storage. Presented research poster to academic panel.",
    skills: [
      "Python",
      "NumPy",
      "Pandas",
  ...
  },
  {
    ...
    date: "Coming Soon",
    summary:
      "Research into swappable battery architectures for electric vehicles and e-mobility applications, exploring digital twin models and battery management systems.",
    methodology:
      "Literature review on digital twin models for BMS, analysis of swappable battery standards, and technical report authoring on viability for EV use cases.",
...
export const achievements: Achievement[] = [
  {
    ...
    date: "Grade 11",
    description:
      "Recognized as Student of the Year in Grade 11 for academic excellence and leadership.",
    waveformType: "sine",
  },
  {
    id: "presidents-award",
    ...
    date: "Grade 12",
    description:
      "Awarded the President's Award at Bronze level for community service and personal development.",
    waveformType: "square",
  },
  {
    id: "chess-champion",
    ...
    date: "",
    description:
      "Achieved National Chess Champion title through competitive excellence and strategic mastery.",
    waveformType: "ramp",
  },
];
