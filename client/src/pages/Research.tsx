...
export default function ResearchSection() {
  ...
  const selectedItem = selectedResearch
    ? research.find(r => r.id === selectedResearch)
    : null;
  ...
  return (
    <div className="relative w-full min-h-screen bg-black overflow-hidden">
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, #0a1a0f 0%, #050a05 60%, #000000 100%)",
        }}
      >
        {/* PCB Grid */}
        ...
        {researchComponents.map(comp => (
          <motion.div
            ...
            onClick={() =>
              setSelectedResearch(selectedResearch === comp.id ? null : comp.id)
            }
          ...
          >
            ...
            >
              ...
              />
              <p
                className="text-xs font-bold text-center z-10 px-2 leading-tight"
                style={{
                  color: comp.color,
                  fontFamily: "'JetBrains Mono', monospace",
                }}
              ...
              {[0, 1, 2, 3].map(i => (
                <div
                  key={`l${i}`}
                  className="absolute w-2 h-0.5 left-0 -translate-x-full"
                  style={{
              ...
              {[0, 1, 2, 3].map(i => (
                <div
                  key={`r${i}`}
                  className="absolute w-2 h-0.5 right-0 translate-x-full"
                  style={{
                    backgroundColor: comp.color,
                    top: `${25 + i * 18}%`,
                    opacity: 0.7,
          ...
          >
            <motion.div
              ...
              style={{
                ...
                borderColor:
                  selectedItem.id === "hyperspectral" ? "#00ff88" : "#ff0088",
                maxHeight: "90vh",
              }}
            >
              ...
              {selectedItem.id === "hyperspectral" && (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(to bottom, transparent 50%, #080f08)",
                    }}
                  />
