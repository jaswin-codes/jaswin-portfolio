      ...
      >
        ...
        <motion.section variants={itemVariants} className="text-center mb-12">
          <p className="text-green-400 text-lg mb-4">
            Passionate about embedded systems, AI safety, and battery
            technologies
          </p>
              ...
              >
                ...
                <div className="space-y-2">
                  {cluster.skills.map(skill => {
                    const profLevel = skill.proficiency as
                    ...
                    return (
                      ...
                      >
                        ...
                        <span
                          className={`text-xs font-semibold px-2 py-1 rounded ${badgeColors[profLevel]}`}
                        >
                          {profLevel.charAt(0).toUpperCase() +
                            profLevel.slice(1)}
                        </span>
                      </div>
                    );
            ...
            {[
              {
                ...
                org: "Interact Club",
                detail:
                  "Managed budgets and financial records over R5000+ for community fundraising reaching multiple local organizations. 1 of 4 Board Members organizing events, running meetings and participated in various service events.",
              },
              {
                role: "Student Wellness and Leadership",
                org: "Student Representative Council (SRC)",
                detail:
                  "Represented the student body as 1 of 9 in school governance, contributing to welfare and leadership initiatives. Organized mental health and wellness events along with counsellor; mentored cohort of class representatives.",
              },
              {
                role: "Class Representative",
                org: "EEE1008 — Electrical Engineering",
                detail:
                  "Elected class representative for EEE1008 at UCT, facilitating communication between students and the course lecturer.",
              },
            ].map(item => (
              <motion.div
                key={item.role}
