...
export default function ProjectsSection() {
  ...
  const screenData = [
    {
      id: "afriguard",
      position: [-3.5, 0.2, -4.5] as [number, number, number],
      rotation: [0, Math.PI / 8, 0] as [number, number, number],
    },
    {
      id: "hyperspectral",
      position: [0, 0.2, -5.5] as [number, number, number],
  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute bottom-16 left-6 z-10 rounded-lg border p-3 text-xs pointer-events-none"
        style={{
          backgroundColor: "rgba(0,0,0,0.7)",
          ...
          >
            ...
            >
              ...
              {project.thumbnail && (
                <div className="relative h-40 overflow-hidden">
                  <img
                    ...
                    style={{
                      objectFit:
                        project.id === "afriguard" ? "contain" : "cover",
                      filter:
                        project.id === "afriguard"
                          ? "none"
                          : "brightness(0.7) saturate(1.2)",
                      background:
                        project.id === "afriguard" ? "#1a2332" : "transparent",
                    }}
                    onError={e => {
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(to bottom, transparent 40%, #0a0f0a)",
                    }}
                  />
              ...
              <div
                ...
                style={{
                  maxHeight: project.thumbnail ? "calc(85vh - 10rem)" : "85vh",
                }}
              >
                {!project.thumbnail && (
